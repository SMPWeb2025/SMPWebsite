    ...
    const content = (<>
        ...
        <p className="mb-4">
            ...
            <ul className="ml-6 list-disc">
                ...
                <li className="mb-2"><b>Seasons of Code (SOC): </b>Seasons of Code is WnCC's flagship summer program where you get to build real impactful projects, learning new technologies and collaborating with amazing mentors from IIT Bombay which are usually your seniors. SOC gives you a chance to explore, build, and grow your skills through an exciting 8-week journey. There are numerous projects from different domains like Machine Learning & AI, Blockchain, Competitive Programming, Web Development, App Development and much more!</li>
                ...
                <li className="mb-2"><b>Summer of Robotics (SOR): </b>SOR is ERC's flagship 6-week robotics program, offering hands-on experience in Mechatronics and ROS 2 through guided sessions, assignments, and project-based learning.</li>
                <li className="mb-2"><b>Krittika Summer Projects (KSP): </b>Organized by Krittika, the Astronomy Club of IIT Bombay, Krittika Summer Projects is a collection of mentored, research projects that integrate essential computational skills (such as Machine Learning, Data Analytics, Visualisation and Simulations) with theoretical astronomy and astrophysics. Each project is headed by domain experts from leading institutes, ans is uniquely designed to be an intensive, enriching research experience. The projects stretch across the entire summer, and are completely online with all the computational work based on python.</li>
            </ul>
        </p>
